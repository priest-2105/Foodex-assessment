      ...
      <div className="relative z-10 max-w-fit mx-auto px-4">
        ...
        <div className="text-center mb-8 relative max-lg:hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-[#353542] text-6xl font-pangram font-bold mb-4">tired of eating the</h2>
        ...
        <div className="text-center mb-8 relative max-lg:block lg:hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-[#353542] text-6xl max-lg:text-3xl font-pangram font-bold mb-4">
            ...
            <p className="text-black max-w-xl my-12 font-semibold text-lg font-sofia-sans-condenced mx-auto max-sm:px-4 max-lg:px-8">
              Do you crave new and exciting dishes? Look no further! Chow is the perfect solution for discovering your
              next dish.
            </p>
          </div>
